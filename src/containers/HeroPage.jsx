...
const HeroPage = () => {
  return (
    <section className="w-screen relative h-full bg-[#D5FF40]">
     <Header/>
     <div className="flex items-center justify-center py-8 p-2 sm:px-4 w-full h-full">
           <div className='flex items-center justify-center px-2 sm:px-4 flex-col max-w-[95%] h-full py-4'>
            <div className='flex items-center justify-start flex-row gap-4 w-full h-full'>
             <div className='flex items-center justify-start s:w-[50%] lg:w-[60%]'><h1 className='text-[2rem] sm:p-2 xs:text-[2.7rem] s:text-5xl sm:text-[4rem] md:text-[5rem] lg:text-8xl xl:text-9xl 2xl:text-[154px] font-black sm:leading-tight text-[#1A1A1A]'>CODE</h1></div>
            ...
            <div className='flex items-center justify-start flex-col-reverse w-full h-full'>
            <div className='flex items-center justify-start w-full h-full'><h1 className='text-[2rem] sm:p-2 xs:text-[2.7rem] s:text-5xl sm:text-[4rem] md:text-[5rem] lg:text-8xl xl:text-9xl 2xl:text-[154px] whitespace-nowrap font-black sm:leading-tight text-[#1A1A1A]'>MANTHON 2K23</h1></div>
            ...
            <div className='xs:flex items-center justify-center flex-row w-full sm:w-[75%] md:w-[65%] lg:w-[50%] sm:p-2 my-4'>
            ...
            <div className="flex items-center justify-center flex-row gap-4 w-full p-1 s:p-4 my-6">
              ...
              <div className="hidden items-center justify-center sm:flex">
                <img src={circle} alt="circle" className="w-12 h-12"/>
              </div>
            </div>
            <div className='flex sm:absolute items-center justify-end bottom-0 right-2 sm:w-auto sm:h-auto w-full h-full'>
        ...
        <div className="flex items-center justify-center rotate-[-90]">
          <img src={instagram} alt="instagram" className="w-4 h-4 sm:w-6 sm:h-6"/>
        </div>
        <div className="flex items-center justify-center rotate-[-90]">
