        ...
        <div className="w-full h-full flex items-center justify-center flex-col ">
                   <div className="flex items-center justify-center w-full h-full">
                           <div className="flex items-center w-full h-full justify-center p-1 sm:p-3 pb-0 sm:pb-0 relative">
                            <div className="flex items-center justify-center max-w-6xl p-1 xs:p-2 pb-0 sm:p-4 sm:pb-0">
                            <div className="flex items-center max-w-6xl justify-center relative p-4 pb-0 xs:p-4 xs:pb-0 sm:p-6 sm:pb-0 mb-14 sm:mb-12 md:mb-8" >
                                ...
                                <img src={play} alt="play" className="motion-safe:animate-[spin_5s_ease-in-out_infinite] w-14 h-14  xs:h-16  xs:w-16 s:h-20 s:w-20  sm:w-24 sm:h-24 lg:w-28 lg:h-28 absolute top-0 right-0"/>
                                </div>
                                </div>
