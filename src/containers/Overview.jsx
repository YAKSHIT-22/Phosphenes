                   ...
                   <div className="flex items-center justify-center w-full h-full">
                           <div className="flex items-center w-full h-full justify-center p-1 sm:p-3 pb-0 sm:pb-0 relative">
                            ...
                            <div className="flex items-center max-w-6xl justify-center relative p-2 pb-0 xs:p-4 xs:pb-0 sm:p-6 sm:pb-0 mb-14 sm:mb-12 md:mb-8" >
                                <img src={bg} alt="bg" className="w-full h-full object-cover rounded-t-[56px] sm:rounded-t-[72px] md:rounded-t-[84px] lg:rounded-t-[112px]"/>
                                <img src={play} alt="play" className="motion-safe:animate-[spin_5s_ease-in-out_infinite]  h-16 w-16 xs:h-20 xs:w-20  sm:w-24 sm:h-24 lg:w-28 lg:h-28 absolute top-0 right-0"/>
                                </div>
                                </div>
